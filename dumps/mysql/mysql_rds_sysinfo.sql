...
--
-- Dumping data for table `rds_sysinfo`
--

LOCK TABLES `rds_sysinfo` WRITE;
/*!40000 ALTER TABLE `rds_sysinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `rds_sysinfo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:54:56
