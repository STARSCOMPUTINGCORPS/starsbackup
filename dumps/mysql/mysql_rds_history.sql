...
--
-- Dumping data for table `rds_history`
--

LOCK TABLES `rds_history` WRITE;
/*!40000 ALTER TABLE `rds_history` DISABLE KEYS */;
INSERT INTO `rds_history` VALUES ('2014-10-24 09:05:01','rdsadmin@localhost','enable set master','5.5.40-log',NULL,NULL,'rdsrepladmin',NULL,NULL,NULL);
/*!40000 ALTER TABLE `rds_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:54:58
