...
--
-- Table structure for table `jos_bbb`
--

DROP TABLE IF EXISTS `jos_bbb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_bbb` (
...
--
-- Dumping data for table `jos_bbb`
--

LOCK TABLES `jos_bbb` WRITE;
/*!40000 ALTER TABLE `jos_bbb` DISABLE KEYS */;
INSERT INTO `jos_bbb` VALUES (1,'Room 1',0,'hcilab300','stars','no');
/*!40000 ALTER TABLE `jos_bbb` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:51:55
