...
--
-- Table structure for table `memberDataNew`
--

DROP TABLE IF EXISTS `memberDataNew`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `memberDataNew` (
...
--
-- Dumping data for table `memberDataNew`
--

LOCK TABLES `memberDataNew` WRITE;
/*!40000 ALTER TABLE `memberDataNew` DISABLE KEYS */;
/*!40000 ALTER TABLE `memberDataNew` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:51:29
