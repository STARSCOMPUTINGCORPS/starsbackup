...
DROP TABLE IF EXISTS `jos_community_register`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_community_register` (
...
--
-- Dumping data for table `jos_community_register`
--

LOCK TABLES `jos_community_register` WRITE;
/*!40000 ALTER TABLE `jos_community_register` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_community_register` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:52:24
