...
DROP TABLE IF EXISTS `jos_community_avatar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_community_avatar` (
...
--
-- Dumping data for table `jos_community_avatar`
--

LOCK TABLES `jos_community_avatar` WRITE;
/*!40000 ALTER TABLE `jos_community_avatar` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_community_avatar` ENABLE KEYS */;
UNLOCK TABLES;
