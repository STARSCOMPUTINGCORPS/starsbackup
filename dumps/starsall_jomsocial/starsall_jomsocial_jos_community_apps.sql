...
DROP TABLE IF EXISTS `jos_community_apps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_community_apps` (
...
--
-- Dumping data for table `jos_community_apps`
--

LOCK TABLES `jos_community_apps` WRITE;
/*!40000 ALTER TABLE `jos_community_apps` DISABLE KEYS */;
INSERT INTO `jos_community_apps` VALUES (1,42,'myarticles',0,'sidebar-top','','');
/*!40000 ALTER TABLE `jos_community_apps` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-13 14:53:04
